...
class Activity:
    ...
    def get_time_entries(
        ...
        return [
            ...
            if time_entry.start_time <= end_time and time_entry.end_time >= start_time
        ]
    ...
    def get_time_spent(
        ...
        for time_entry in time_entries:
            ...
            if time_entry.start_time >= start_time and time_entry.end_time <= end_time:
                ...
                time_entry.start_time <= start_time and time_entry.end_time <= end_time
            ):
    ...
    def serialize(
        ...
        _time_spent = self.get_time_spent(
            start_time=start_time, end_time=end_time
        ).total_seconds()
        time_spent = t.strftime("%H:%M:%S", t.gmtime(_time_spent))
        return {
            "window_title": self.window_title,  # self.window_title.encode('utf-8'),
            "time_entries": [
                time_entry.serialize()
    ...
    def to_json(
        ...
        # return json.dumps(self.serialize(start_time=start_time, end_time=end_time))
        return self.serialize(start_time=start_time, end_time=end_time)
